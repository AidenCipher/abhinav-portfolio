...
export default function DynamicBackground() {
    ...
    useEffect(() => {
        ...
        // The swarm is pure motion — there is nothing left to show once it is
        // stilled, so sit it out entirely for reduced-motion users.
        ...
        // Don't burn frames on a background nobody is looking at.
        const onVisibility = () => {
            if (document.hidden) {
